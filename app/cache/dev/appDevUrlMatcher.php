...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'sam_user_homepage')), array (  '_controller' => 'SAM\\UserBundle\\Controller\\DefaultController::indexAction',));
        }

        if (0 === strpos($pathinfo, '/user')) {
            // sam_user_index
            if ($pathinfo === '/user/index') {
                return array (  '_controller' => 'SAM\\UserBundle\\Controller\\UserController::indexAction',  '_route' => 'sam_user_index',);
            }
            ...
            if (0 === strpos($pathinfo, '/user/view') && preg_match('#^/user/view/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sam_user_view')), array (  '_controller' => 'SAM\\UserBundle\\Controller\\UserController::viewAction',));
            }
